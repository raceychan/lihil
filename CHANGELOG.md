...
### Added
- Managed WebSocket hub: `SocketHub` now drives class-based channels (`ChannelBase`) with regex topic patterns via `Topic("room:{id}")`, lifecycle hooks (`on_join/on_message/on_exit`), and bus fanout (`publish/broadcast`).
